...
rare_variant =   vep [
    ...
    (vep['gnomADe_AF'] <0.001) &(vep['gnomADe_AFR_AF'] <0.001) &(vep['gnomADe_AMR_AF'] <0.001) &
    (vep['gnomADe_EAS_AF'] <0.001) &(vep['gnomADe_NFE_AF'] <0.001) &(vep['gnomADe_OTH_AF'] <0.001) &  
    
    (vep['TCGA_AFR_AF'] <0.001)&(vep['TCGA_AMR_AF'] <0.001)&(vep['TCGA_EAS_AF'] <0.001)&(vep['TCGA_EUR_AF'] <0.001)&
    (vep['TCGA_NAN_AF'] <0.001)&(vep['TCGA_PAS_AF'] <0.001)&(vep['TCGA_AF'] <0.001)
              ]
...
clinvar = rare_variant[(rare_variant['ClinVar_CLNREVSTAT'].isin(["practice_guideline",'criteria_provided,_multiple_submitters,_no_conflicts' , 'reviewed_by_expert_panel'])) &
...
ptv = rare_variant[(rare_variant['Consequence'].isin(['frameshift_variant', 'stop_gained', 'start_lost', 'stop_lost','frameshift_variant,splice_region_variant', 'frameshift_variant,stop_lost,splice_region_variant',
...
benign = rare_variant[(rare_variant['ClinVar_CLNREVSTAT'].isin(["practice_guideline",'criteria_provided,_multiple_submitters,_no_conflicts' , 'reviewed_by_expert_panel'])) &
...
PTV_other = rare_variant[
    (rare_variant['is_rdgv']==True) & (rare_variant['is_ptv']==True) & (rare_variant['Consequence'].isin(['frameshift_variant', 'stop_gained', 'start_lost', 'stop_lost','frameshift_variant,splice_region_variant', 'frameshift_variant,stop_lost,splice_region_variant',
                                                         'start_lost,splice_region_variant', 'frameshift_variant,start_lost,start_retained_variant','inframe_insertion,stop_retained_variant', 'protein_altering_variant']))
                         ]
