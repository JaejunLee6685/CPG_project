...
ptex_combined = pd.read_csv(snakemake.input['pext_combine'],compression='gzip', sep='\t', low_memory=False)
...
FINAL2.to_csv(snakemake.output['pext_fin'], sep='\t', compression='gzip', index=False)