...
ML_pipe = LGBMClassifier(random_state=35)


# grid search CV to find out optimal hyperparameter
param_grid = {
    'n_estimators': [50, 100, 200],
    'learning_rate': [0.01, 0.1, 0.3],
    'num_leaves': [15, 31, 63],  # Número de hojas en cada árbol
    'max_depth': [-1, 3, 5],  # Profundidad máxima del árbol (-1 para sin límite)
    'min_child_samples': [10, 20, 50],  # Muestras mínimas por hoja
    'subsample': [0.7, 0.8, 1.0],  # Fracción de datos usados en cada iteración
